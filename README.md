# Итоговый проект по курсу Skillbox Веб-вёрстка продвинутый уровень. 

При выполнении проекта исползуется Gulp - сборка от MaxGraph (https://github.com/maxdenaro/gulp-maxgraph)

> Используется Gulp 4

> Дабавлена команда npm run deploy!!!
...
`npm run deploy` - команда соберёт продакшн-сборку и зальёт в ветку gh-pages в ваш удалённый репозиорий.
